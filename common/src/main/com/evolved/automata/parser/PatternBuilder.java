...
public class PatternBuilder {
	...
	public void setPattern(String patternName, String patternDefinition, boolean compileImmediately)
	{
		parser.setNonTerminal(patternName, patternDefinition, compileImmediately);
		components.put(patternName, patternDefinition);
		if (compileImmediately)
			addPatternInfo();
	}
	
	public PatternBuilder compileBuilder()
	{
		addPatternInfo();
		return this;
	}
