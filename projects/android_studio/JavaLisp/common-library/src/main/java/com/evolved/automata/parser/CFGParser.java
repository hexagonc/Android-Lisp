...
//	public static com.evolved.automata.filetools.SimpleLogger log;
	...
	private String[] _grammarDefinition;
	...
	public void setNonTerminal(String nonterminalName, String definition, boolean rebuildCompiledMap)
	{
		namedComponents.put(nonterminalName, definition);
		if (rebuildCompiledMap)
			buildNonTerminalParseMap();
	}
	
	public CFGParser buildParser()
	{
		buildNonTerminalParseMap();
		return this;
	}
