...
/**
 * Created by Evolved8 on 3/9/17.
 */
public class SpeechProcessingMetaphoneTests extends TestHarnessBase
{
    ...
    public void testScoringPatterns()
    {
        ...
        SpeechMap.FunctionApplicabilityData result = map.assessPattern(new SpeechMap.ProcessStateInfo("speech-add"), map.getTokenizedInput(tokenizedInput), tokenizedPattern);
        ...
        result = map.assessPattern(new SpeechMap.ProcessStateInfo("speech-add"), map.getTokenizedInput(tokenizedInput), tokenizedPattern);
    ...
    final SpeechExternalInterface _topEvaluator = new SpeechExternalInterface()
    {
        ...
        @Override
        public SpeechMap.FunctionApplicabilityData onAmbiguousResult(
                SpeechMap.FunctionApplicabilityData[] possibilities, boolean isTop) {

            try
            {
                FunctionTemplate template = env.getFunction(ambiguity_handler_function_name);
                Value[] args = new Value[possibilities.length];
                SpeechMap.FunctionApplicabilityData data;
            ...
            {
                e.printStackTrace();
                return new SpeechMap.FunctionApplicabilityData(0, null).setFailureRejected();
            }
        }
     ...
     * @return
     */
    public Value  convertFunctionApplicabilityData(SpeechConfig config, SpeechMap.FunctionApplicabilityData data)
    {
        ...
        SpeechMap.FUNCTION_APPLICABILITY_STATUS status = data.status;
    ...
    public SimpleFunctionTemplate create_speech_config()
    {
        return new SimpleFunctionTemplate()
        {
            ...
            public Value evaluate(Environment env, Value[] evaluatedArgs) {
                ...
                wrapper._internalConfig.setUseMetaphoneMatching(true);
